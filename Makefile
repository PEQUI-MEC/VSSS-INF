...
VSSS: welcome src/aux/jsonSaveManager.o src/vision/vision.o src/vision/gmm.o src/vision/tag.o src/kalmanFilter.o src/gui/robotGUI.o src/gui/controlGUI.o src/serialW.o src/communication/serialCom.o src/communication/flyingMessenger.o src/gui/filechooser.o src/gui/imageView.o src/gui/visionGUI.o src/gui/testFrame.o src/capture/v4lcap.o src/gui/v4linterface.o src/gui/v4linterfaceEvents.o src/fuzzy/fuzzyController.o src/fuzzy/fuzzyFunction.o src/fuzzy/rules.o src/main.o
	...
	@$(COMPILER) -w -L"/usr/local/lib" -L"/lib64" -o "VSSS"  "src/main.o" "src/pack-capture-gui.a" "src/aux/jsonSaveManager.o" "src/vision/vision.o" "src/kalmanFilter.o" "src/gui/robotGUI.o" "src/gui/controlGUI.o" "src/serialW.o" "src/communication/serialCom.o" "src/communication/flyingMessenger.o" "src/gui/filechooser.o" "src/gui/imageView.o" "src/gui/visionGUI.o" "src/vision/tag.o" "src/vision/gmm.o" "src/gui/testFrame.o" "src/fuzzy/fuzzyController.o" "src/fuzzy/fuzzyFunction.o" "src/fuzzy/rules.o" -lopencv_shape -lopencv_stitching -lopencv_objdetect -lopencv_superres -lopencv_videostab -lxbee -lopencv_calib3d -lopencv_features2d -lopencv_highgui -lopencv_videoio -lopencv_imgcodecs -lopencv_video -lopencv_photo -lopencv_ml -lopencv_imgproc -lopencv_flann -lopencv_core -lboost_thread -lboost_system `pkg-config gtkmm-3.0 libv4l2 libv4lconvert --cflags --libs`
...
welcome:
	...
	@echo "\n\033[0;37mThis script will build only necessary objects.\033[0m\n"

# verifica se algum hpp ou cpp foi alterado e compila a main se precisar
src/main.o: src/main.cpp $(SOURCES)
	@echo "\033[92mCompiling main program...\033[0m\n"
	@$(COMPILER) -w -O0 -g3 -Wall -c "src/main.cpp" -o "src/main.o" `pkg-config gtkmm-3.0 --cflags`


####### AUXILIARES #######

# objeto do jsonSaveManager
src/aux/jsonSaveManager.o: src/aux/jsonSaveManager.cpp
	@echo "\033[92mCompiling JSON Save Manager object...\033[0m\n"
	@$(COMPILER) `pkg-config gtkmm-3.0 --cflags` -O3 -Wall -c "src/aux/jsonSaveManager.cpp" -o "src/aux/jsonSaveManager.o"

####### CAPTURA #######

# objeto do v4lcap (captura)
src/capture/v4lcap.o: src/capture/v4lcap.cpp
	@echo "\033[92mCompiling V4LCap object...\033[0m\n"
	@$(COMPILER) -O0 -g3 -w -c "src/capture/v4lcap.cpp" -o "src/capture/v4lcap.o"

# objeto ImageView
src/gui/imageView.o: src/gui/imageView.cpp
	@echo "\033[92mCompiling ImageView object...\033[0m\n"
...
src/vision/vision.o: src/vision/vision.cpp
	@echo "\033[92mCompiling Vision object...\033[0m\n"
...
src/vision/tag.o: src/vision/tag.cpp
	@echo "\033[92mCompiling Tag object...\033[0m\n"
...
src/vision/gmm.o: src/vision/gmm.cpp
	@echo "\033[92mCompiling GMM object...\033[0m\n"
...
src/kalmanFilter.o: src/kalmanFilter.cpp
	@echo "\033[92mCompiling Kalman Filter object...\033[0m\n"
...
src/fuzzy/fuzzyController.o: src/fuzzy/fuzzyController.cpp
	@echo "\033[92mCompiling Fuzzy Controller object...\033[0m\n"
...
src/serialW.o: src/serialW.cpp
	@echo "\033[92mCompiling SerialW object...\033[0m\n"
...
src/communication/serialCom.o: src/communication/serialCom.cpp
	@echo "\033[92mCompiling SerialCom object... \033[0m\n"
...
src/communication/flyingMessenger.o: src/communication/flyingMessenger.cpp
	@echo "\033[92mCompiling FlyingMessenger object... \033[0m\n"
...
src/gui/visionGUI.o: src/gui/visionGUI.cpp
	@echo "\033[92mCompiling Vision GUI object...\033[0m\n"
...
src/gui/robotGUI.o: src/gui/robotGUI.cpp
	@echo "\033[92mCompiling Robot GUI object...\033[0m\n"
...
src/gui/controlGUI.o: src/gui/controlGUI.cpp
	@echo "\033[92mCompiling Control GUI object...\033[0m\n"
...
src/gui/testFrame.o: src/gui/testFrame.cpp
	@echo "\033[92mCompiling Test Frame object...\033[0m\n"
...
src/gui/filechooser.o: src/gui/filechooser.cpp
	@echo "\033[92mCompiling File Chooser object...\033[0m\n"
...
src/gui/v4linterface.o: src/gui/v4linterface.cpp
	@echo "\033[92mCompiling Main Interface object...\033[0m\n"
...
src/gui/v4linterfaceEvents.o: src/gui/v4linterfaceEvents.cpp
	@echo "\033[92mCompiling Main Interface Events object...\033[0m\n"
